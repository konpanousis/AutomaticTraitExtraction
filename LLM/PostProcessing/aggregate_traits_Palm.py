...
if __name__ == '__main__':
    ...
    results_path = '../Results/Mistral/Palm'

    # First read the ground truth traits
    traits_path = '../Data/Traits/Palm.json'
    ...
    gt_traits_path = '../Data/DataFrames/DF_Palm.csv'
    ...
    for spec in nas_per_species:
        ...
        spec_na_perc[spec] = na_num / (len(traits.keys()) - 1)
    ...
    for spec in species_wide_llm_traits:
        ...
        metrics_per_species[spec] = classification_report(gt_presence_full, llm_presence_full, output_dict=True, labels=[0,1])
        metrics_per_species_na[spec] = classification_report(gt_presence_without_na, llm_presence_without_na,
                                                             output_dict=True, labels=[0,1])

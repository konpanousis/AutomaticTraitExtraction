...
if __name__ == '__main__':
    ...
    results_path = '../Results/Mistral/Caribbean'

    # First read the ground truth traits
    traits_path = '../Data/Traits/Caribbean.json'
    ...
    gt_traits_path = '../Data/DataFrames/DF_Caribbean.csv'
        ...
        for row in reader:
            ...
            for idx, tr in enumerate(header_traits[1:]):
                ...
                if tr not in species_wide_gt_traits[spec_name]:
                    ...
                    for val in traits[tr.capitalize()]:
                        val = val.lower()
